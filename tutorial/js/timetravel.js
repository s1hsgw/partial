(function ($) {
    ...
    document.oncontextmenu = activateTimeTravel;
    ...
    function init() {
        //２つのビューアを順番に起動
        var myPromise = $.when($('#main-viewer').createMainThetaViewer('images/tutorial_original.JPG'));

        myPromise.done(function () {
            $clone.createCloneThetaViewer('images/tutorial_remake.JPG');
        });
