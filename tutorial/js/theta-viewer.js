...
//      that.wireframe = new THREE.WireframeHelper( that.mesh, 0x00ff00 );
      that.scene.add(that.mesh);
//      that.scene.add(that.wireframe);
    }
    ...
    function createMyMesh(that) {
      var myObject = {};
      myObject.geometry = new THREE.CubeGeometry(100, 100, 100);
      myObject.material = new THREE.MeshBasicMaterial({
        color: 0xff0000
    });
      myObject.mesh = new THREE.Mesh(myObject.geometry, myObject.material);
      that.scene.add(myObject.mesh);
    }
